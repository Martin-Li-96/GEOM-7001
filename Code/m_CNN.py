...
with strategy.scope():
    ...
    model = tf.keras.Sequential([
        input_layer,
        tf.keras.layers.Conv2D(64, (4, 4), activation='relu', kernel_regularizer=regularizers.l2(0.001)),
        tf.keras.layers.Conv2D(128,(4,4),activation='relu', kernel_regularizer=regularizers.l2(0.001)),
        tf.keras.layers.MaxPooling2D((4,4)),
        tf.keras.layers.Conv2D(256, (3,3), activation='relu',kernel_regularizer=regularizers.l2(0.001)),
        tf.keras.layers.MaxPooling2D((3, 3)),
        tf.keras.layers.Conv2D(512, (2, 2), activation='relu', kernel_regularizer=regularizers.l2(0.001)),
...
history=model.fit(train_dataset, epochs=120,verbose=1,validation_data=test_dataset,callbacks=[CustomCallback()])
