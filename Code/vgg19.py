...
checkpoint_filepath = './VGG19/Final-{epoch:02d}-{val_accuracy:.4f}.keras'
...
with strategy.scope():
    ...
    model = tf.keras.Sequential([
        tf.keras.applications.VGG19(weights=None,include_top=False,input_shape=(64,64,13),pooling='max'),
