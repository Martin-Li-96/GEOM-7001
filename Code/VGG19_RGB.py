...
checkpoint_filepath = './RGB_VGG19/RGB_VGG19-{epoch:02d}-{val_accuracy:.4f}.keras'
...
with strategy.scope():
    ...
    model = tf.keras.Sequential([
        tf.keras.applications.VGG19(weights="imagenet",include_top=False,input_shape=(64,64,3),pooling='max'),
...
history=model.fit(train_dataset, epochs=300,verbose=1,validation_data=test_dataset,callbacks=[CustomCallback(),model_checkpoint_callback, tensorboard_callback ])
